      ...
      <nav className="w-full flex justify-between gap-6 relative">
        <div className="min-w-max inline-flex relative">
          <a href="/" className="relative flex items-center gap-3">
            <img src={LogoIcon} alt="EdgeWebLogo" className="w-10 h-10" />
            <div className="inline-flex text-lg font-semibold text-heading-1">EdgeWeb</div>
          </a>
        </div>
        ...
        <div className="flex flex-col lg:flex-row w-full lg:justify-between lg:items-center absolute top-full left-0 lg:static lg:top-0 bg-body lg:bg-transparent border-x lg:border-x-0 lg:h-auto h-0 overflow-hidden">
          ...
          <div className="lg:min-w-max flex items-center sm:w-max w-full pb-6 lg:pb-0 border-b lg:border-0 px-6 lg:px-0">
